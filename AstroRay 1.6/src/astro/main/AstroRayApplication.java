...
import astro.db.LocationDAO;
import astro.model.AstroFunctions;
import astro.model.BirthData;
import astro.model.Ephemeris;
import astro.model.House;
import astro.model.Planet;
import astro.ui.FrmBirthData;
import astro.ui.TextChart;
import astro.ui.TextToPdfConverter;
import java.io.File;
...
public class AstroRayApplication {
    ...
    public AstroRayApplication() {
        ...
        defaultProps.setProperty("output_txt_dir", "C:/Horoscopes/Txt");
        defaultProps.setProperty("output_pdf_dir", "C:/Horoscopes/Pdf");
        defaultProps.setProperty("pdf_reader_exe", "C:/Program Files/Adobe/Reader 9.0/Reader/AcroRd32.exe");
    ...
    public void viewPdfFile() throws Exception {
        ...
        runTime.exec(pdfReaderExe + " " + pdfFile.getAbsolutePath());
    }
